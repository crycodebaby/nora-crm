# Release-Archiv 2026-06

## Release-Chronik Juni 2026

Alle Einträge datieren auf den 2026-06-28 (Gründungswellen). Kein Production-Release-Prozess; lokal verifiziert (`db reset`, `typecheck`/`build`, `dev:demo`). Migrationen sind heute im Production-Ledger enthalten (Stand 2026-09-06).

| Welle | Migration | Evidenz |
|---|---|---|
| Atomic CRM als Basis · Resource-Namen stabil · Deals → Vorgänge · Brandfarbe · EUR/de-DE · Demo-Daten synthetisch | keine | Originaleinträge unten |
| Welle 4 Typografie · Welle 5 Nachfassen · Welle 6a Startseite · 6a-Polish Auth-Navigation · Kanban-Polish | keine | Originaleinträge unten |
| Welle 6b Nummern-Spezifikation · 6c Nummern implementiert · 6c-QA · 6c-Hardening | `20260628130000_customer_and_case_numbers`, `20260628140000_numbering_api_hardening` | Originaleinträge unten |
| Welle 7a Fensterauftrag (Spezifikation) · 6d Globale Suche · v0.3b Hotboard · v0.3c Fenster-Kanban-Filter | keine | Originaleinträge unten |
| Welle 7b Checklisten/Textbausteine/Audit (Spezifikation) · v0.3d2 Migration · v0.3d3 Run-Start · v0.3d4 UI · v0.3d5 Hotboard-Kachel | `20260628150000_checklists_snippets_audit`, `20260628160000_start_checklist_run_from_template` | Originaleinträge unten |
| v0.3e Schnellerfassung · v0.3f Dubletten-Vorschläge | keine | Originaleinträge unten |
