...
**Ergebnis: PRODUCTION VERIFIED.** Kein DB-Rollback nötig. Weiterhin offen (siehe oben, „Offen bleibt"): authentifizierter End-to-End-HTTP-Beweis (echter `authenticated`-User-JWT statt `service_role`/Katalog-Ebene).
