...
7. **Keine Oberflächenabbildung des neuen Fehlercodes in S3A.** Es gibt keinen Aufrufer, der Zeilen schreibt; die Abbildung von `NORA_ATTACHMENT_STORAGE_KEY_PENDING_DELETION` gehört zu dem Schnitt, der erstmals schreibt.
