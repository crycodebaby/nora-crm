...
**Status:** `RC VERIFIED — nicht released` (2026-09-07; Migration `20260906230000_nora_lifecycle_account_deletion`, `users`-Edge-Änderung, Frontend). Aktueller Vertrag: `19-user-lifecycle-architecture.md` §15; Guardrails: `03-data-model-guardrails.md` „Kontrollierter Hard Delete"; Release-Evidenz und Runbook: `releases/2026-09.md` (Eintrag W6-B).
