...
**Status:** `RC — NOT YET PRODUCTION APPLIED` (RC `0fb3d6ba6a52613e366c780586c4988d264c61eb`, Base `7d85acbd`; Migration `20260908120000_nora_atomic_contact_primary_intent`, LF SHA-256 `0354bdec34c527a598529ba4309247154d7ec6838722ac7953c7dc4d56af4f6f`). Zwei frühere RCs wurden von unabhängigen Reviews als **release-blockierend zurückgewiesen** und dürfen nicht releast werden: `cf48560b` (Hash `d3352113fd001d53…`, Cross-Command-Deadlock) und `b161a4f9` (Hash `edf8346fa947cb6c…`, Trigger-Deadlock). Beide Nachträge stehen am Ende dieses Eintrags. Release-Evidenz: `releases/2026-09.md` (Eintrag Atomic Contact Primary Intent). Modell: `01-domain-model.md`; Guardrail: `03-data-model-guardrails.md` Falle 40.
