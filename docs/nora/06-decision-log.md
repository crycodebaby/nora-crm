...
4. **Kein Bundle-Budget-Tuning in einer Hygiene-Änderung.** H1 ändert keinen JS-Chunk und keine Budgetzahl; das bereits vorher rote Entry-Chunk-Budget (1092 kB > 1050 kB) bleibt eine eigene Welle (H2) — `17-known-issues-and-planned-waves.md` I.1.
