...
### H.1 Anhänge / Storage — offen nach W8-C S6-A (2026-09-22)
...
Ebenfalls **nicht** offen ist **W8-C S6-A** (Attachment Ordinal, `CLOSED / PRODUCTION VERIFIED` 2026-09-22, Migration `20260922140000_nora_attachment_ordinal`, Ledger 68/68): `public.attachments` trägt jetzt `ordinal integer NOT NULL` ohne Default und eine nicht aufschiebbare Eindeutigkeitsregel pro Notiz (`UNIQUE NULLS NOT DISTINCT`). Die 31 Bestandszeilen wurden in Legacy-Reihenfolge befüllt; der kanonische Prüfer war `GREEN`, die Warteschlange leer. Der Commit `eba95108` ändert keine Zeile in `src/**`; Lesepfad, JSON-Schreibpfad, Bucket und physischer Löschpfad bleiben unverändert. S6-A liefert die relationale Ordnungsgrundlage, **nicht** den Autoritätswechsel. Evidenz: `releases/2026-09.md`.
...
- **Der Löschpfad ist in Schnitte zerlegt — sie werden nicht zusammengezogen.** Reihenfolge und Zustand:
  ...
  - **S6-A relationale Ordnungsgrundlage** — `CLOSED / PRODUCTION VERIFIED` (2026-09-22), siehe oben.
