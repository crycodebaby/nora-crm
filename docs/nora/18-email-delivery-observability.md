...
2026-09-04). Die Plattform führt die deployte Edge Function
`brevo-email-events` heute als Version 3 (read-only verifiziert 2026-09-18,
aktuelle Versionsangaben in `16-current-state.md`); das ausgelieferte Bundle
ist byteidentisch mit dem Artefakt, das im V1C-B-Release vom 2026-09-04 als
Version 2 dokumentiert wurde. Die Versionsangaben v1/v2 in diesem Dokument
sind historische Release-Labels.
...
im echten Betrieb (V1C-A.7 — die `subject_present`-Diagnose ist mit dem
V1C-B-Deploy vom 2026-09-04 eingeführt worden, damals als v2 dokumentiert, und
seitdem noch nie ausgelöst worden, weil keine Nora-E-Mail versendet wurde),
