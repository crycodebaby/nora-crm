...
Stand: 2026-09-16 · Load-Klasse: **ALWAYS** · Status: **CURRENT SNAPSHOT**
...
Stand seit W8-B (`PRODUCTION VERIFIED` 2026-09-16). Der vollständige Access-Contract dazu steht in [`22`](22-security-and-access.md) Abschnitt 6.5, die verbliebenen Risiken in [`17`](17-known-issues-and-planned-waves.md) Abschnitt H; hier nur der Ist-Zustand.
...
| Datenbank | `nora-crm-prod` (`kixxroxtfzbcbzctohex`), Postgres 17.6; Migrations-Ledger **60 Einträge, Kopf `20260915120000_nora_attachment_storage_hardening`**, deckungsgleich mit `supabase/migrations/` (60 Dateien) | Ledger-Abgleich nach dem W8-B-Apply (über die kanonische CLI, ohne Ledger-Korrektur), 2026-09-16 |
