...
- **Fehler/Operationen:** `NoraErrorCode` über `DETAIL`, Operation Manager mit `execution`/`errorCode`/`result`, Idempotency-Records — Contract seit CR3: [`23-operations-errors-feedback.md`](23-operations-errors-feedback.md) (Lifecycle, Correlation, Idempotency, Error Observatory) plus `03-data-model-guardrails.md` §6 (Fehlervertrag); `06-decision-log.md` 2026-08-28/29, `domain/noraErrorCodes.ts`, `operations/*`.
- **Feedback:** eine Statuskarte pro Intent, über Dialogen, click-through; nur Quick Capture migriert, sonner für alle anderen Flows — Bedeutung: [`23-operations-errors-feedback.md`](23-operations-errors-feedback.md) §5, Darstellung: `02-design-system.md`; `notifications/*`.
