...
| Letzter Laufzeit-Release (Frontend) | Startseite-Zuverlässigkeit W7-R1A, Laufzeit-RC **und** Release-Kopf `8fcb603dac7db3599695c031a7fc3ef702892fa3` (2026-09-08; **frontend-only** — keine Migration, kein Edge-Deploy, keine Production-DB-Änderung) | Archiv `releases/2026-09.md` (Startseite-Zuverlässigkeit W7-R1A) |
...
| Frontend | Vercel-Projekt `nora-crm`, Domain `nora.ergart.de`, automatisches Production-Deployment pro Push auf `main`; fachlich Stand Startseite-Zuverlässigkeit W7-R1A `8fcb603d` (Deployment `dpl_5hoV6Gx8MR8MmjKuJbtrapqqAVRY`, READY, Entry-Chunk `assets/index-KB7N0NiF.js`) | Release-Archiv `releases/2026-09.md` |
