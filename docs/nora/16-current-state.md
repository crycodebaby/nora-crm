...
18. **Kontakterstellung UI-Polish** (2026-08-28): Die ursprüngliche mobile-first Sektionsstruktur, feste Nora-Primäraktion, mobile Kundenwahl als Bottom Sheet mit getrennter Neuanlage sowie verdichtete iPad-Kopfzeile sind **DEPLOYED** (Commits auf `origin/main`, live auf `nora.ergart.de` bestätigt). **Lokale Ruhe-/Hierarchie-Iteration vom 2026-08-31:** eine gemeinsame Erfassungsfläche statt vier gleichgewichteter Karten, eindeutige Reihenfolge „Person“ → „Kunde und Rolle“ → „Erreichbarkeit“ → „Interne Angaben“, neutrale Statushinweise „Erforderlich“/„Optional“, zurückgenommene Farbakzente und mindestens 44 px hohe Speicheraktion auch im mobilen Sheet. Reine UI-/i18n-Änderung, keine Persistenz- oder Routingänderung. **LOCAL VERIFIED — AWAITING PRODUCT OWNER UX ACCEPTANCE; NICHT DEPLOYED.** Die finale Rollen-UX-Abnahme (`12-role-ux-acceptance.md`) bleibt offen. Siehe Decision Log „2026-08-28 – Kontakterstellung UI-Polish“, Nachträge.
