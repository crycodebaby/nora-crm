export const englishCrmMessages = {
  resources: {
    ...
    contacts: {
      ...
      create_form: {
        intro:
          "Start with the name; add the customer relationship and contact details when known. Internal details can follow later.",
        person: "Person",
        person_help: "Name and form of address",
        customer: "Customer and role",
        customer_help: "Customer, position and primary-contact status",
        contact_methods: "Reachability",
        contact_methods_help: "Email addresses and phone numbers",
        additional: "Internal details",
        additional_help: "Links, background and assignment",
        required: "Required",
        optional: "Optional",
