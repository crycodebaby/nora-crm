...
export const germanCrmMessages = {
  resources: {
    ...
    contacts: {
      ...
      create_form: {
        intro:
          "Name zuerst; Kundenbezug und Erreichbarkeit ergänzen, soweit bekannt. Interne Angaben können später folgen.",
        person: "Person",
        person_help: "Name und Anrede",
        customer: "Kunde und Rolle",
        customer_help: "Kunde, Position und Hauptansprechpartner",
        contact_methods: "Erreichbarkeit",
        contact_methods_help: "E-Mail-Adressen und Telefonnummern",
        additional: "Interne Angaben",
        additional_help: "Links, Hintergrund und Zuständigkeit",
