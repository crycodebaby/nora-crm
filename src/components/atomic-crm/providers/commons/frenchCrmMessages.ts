...
export const frenchCrmMessages = {
  resources: {
    ...
    contacts: {
      ...
      create_form: {
        intro:
          "Commencez par le nom ; ajoutez le lien client et les coordonnées s’ils sont connus. Les informations internes peuvent suivre plus tard.",
        person: "Personne",
        person_help: "Nom et formule d’adresse",
        customer: "Client et rôle",
        customer_help: "Client, fonction et statut de contact principal",
        contact_methods: "Joignabilité",
        contact_methods_help: "Adresses e-mail et numéros de téléphone",
        additional: "Informations internes",
        additional_help: "Liens, contexte et attribution",
